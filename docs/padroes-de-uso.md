...
3. **Resultado:**
   ...
   - **Duplicada é decidida pelo valor:** só quando o lançado com o número da nota **passa** do valor da nota; nota com vários itens lançada numa linha só ou item por item não é duplicada. O valor da duplicada é o excedente, e aparecem só as linhas que sobram.
   - **Nota com mais de um CFOP** (ex.: NF 21112 = CFOP 1411 + CFOP 1201): a linha com o valor do item do **outro** CFOP não é duplicada — vai pra **A mais na conta** com a dica no participante ("· é do CFOP 1201 (conta 60502)").
